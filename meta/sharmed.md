...
double rng(t; unless stress testing; until limit #xalx) auth; long-term, and short-term, grand master of ram(aḥ x ot), within range(touch typing /speed|a x u racy/,..),..
