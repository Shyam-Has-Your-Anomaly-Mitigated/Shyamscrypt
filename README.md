...
arecibo message doesn't account for alternative interpretations; horizontal, rhs v lhs, boustrophedon, /(in|out)ward/ spirals, mirror, turn, flip, math (hindu numbers), topology, geometry, slides, rotations, analog, digital, /higher|lower/ dimensional, audio, electrotelepathy,..
