...
[ ] dialects:
 ...
 [ ] haskell propagators v http://minikanren.org/#Haskell
  ...
  - the little typer; pi@racket sicp@racket emacs@elisp guix@guile stumpwm@cl js@clojurescript java@clojure py@hy webasm@googleschism
...
animal intelligence experiment: if human parents-to-be(or-not) exclusively limit themselves to simple tasks {sleeping,crawling,drinking through straws}; will the (ectoplasm covered) baby find it easier to learn these tasks? (meditationally telepathic) animal communication like nārada to prahlāda, butt kiss (if you'ren't hercules, nor xena(phobic))
...
some claim sfx from emotional outbursts towards rice, some claim health benefits from smelling flatulence, some (me, myself, and i) claim loss of ident from transplanting belly brains (and /nervous|tree/ rings, bloody transfusions,..), some (/mma?i/) claim health benefits for pets.. from floral aromatherapy (tree magic), some claim s/(empathicity|browsing house episodes; echovirus 11, mimicry, mirror syndrome, synchronisation,..) (thoughty3%)/signed feedback looping (mma?i)/ from gut' moody microbiota #effervescence
a matter of import
