...
cellular automata supports 0D, 1D, 2D, 3D, 4D,.. hacking; /lists|predicates|functions/ are higher dimensional, linearly algebraic vectors (and clusters of mattresses; nearest neighbours,..),..
