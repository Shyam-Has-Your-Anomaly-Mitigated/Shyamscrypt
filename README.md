...
[ ] dialects:
 ...
 [ ] haskell propagators v http://minikanren.org/#Haskell
  ...
  - prolog is a theorem prover v coq flag for isabelles' hol; pagent(gallinas' cup v isabelles' hole(s) v adas' gash v whores' cockette(; /illusionists|magicians|witches|big tits zombie whores/ guard empty chests, after laying their log(s), while casting their spill(s), before cackling away))
