...
mercury types, or better; 2^(power∘parameters) {dependent,..} types, ≤1 type inhabitance by default (dis-able-able for educational edification, make it possible to check multiple overlapping types like duffs' device)
