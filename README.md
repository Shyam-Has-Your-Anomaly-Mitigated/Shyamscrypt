...
+ 'emorising'auuthentication's'robably'he'ost'seful'ho'itch'..
-           ^π
...
mercury types, or better; 2^(power∘parameters) {dependent,..} types, ≤1 type inhabitance by default (dis-able-able for educational edification, make it possible to check multiple overlapping types like duffs' device like dragon quine like..)
...
[ ] need to find the symbolic purity, and put it here…
 ...
 - whitemail = call = eval
 - kaa = /(de)rave(a|l)?ling/; perlytic, pc = perl cryptic, line noise,..
 ...
 - f(list, null); so map(f,l,𝄞n),..
  - mixed types; "3", 51, (list (list (tsil)) (list tsil) (list (tsil)) (tsil)), constant_three, variable_three, (magical 3),.. (is `3` self-documenting?)
  - hex = monotyping
...
[ ] reading den:
 ...
 [x] prime hindu numbers for the taking of psychological edging (https://www.youtube.com/watch?app=desktop&v=Yv4tI6939q0&t=27m)
  ...
  [x] motivational posters v environmentaland synergy(stic mnemonic palace) #rdos
  [x] 2ⁿᵈ
 [x] vegan hot chocolate-salty-balls teabagging-the size-matters-mug litre-long measuring-jug of-invisibility (https://www.youtube.com/watch?v=xfQM4cRXho8&list=PL3XZNMGhpynN3A-pst5vsUTxDwGeMCk8W&t=13m#kirsty=stacey&phil=chad&outcel=broth\el&https://www.youtube.com/watch?v=ubEwaITzTKc&t=17m#freya_is_my_queen__after_killed_c̄_coffee(dire trip' junko furuta makes the yakuza look like the unsullied, and i paused to fap at about 13m; when i just thought this is childs play compared to what i do (∵ i play c̄ arseholes aswell), as a drop is compared to a bucket, where the beyond infinite height determines the final state of your bucket i kick (physical manifestation of karma; equal, and opposite, reactions); that bucket being your artificial soul, proven to exist in the codebase of your /so called reality|inception/, along c̄ your perception)(the $5-0 is the most powerful organised crime syndicate you can join; unlike judges (50%), they (100%) always try to screw everybody over #tunnel_vision; any (other) gang is so weak, none of them can stand on their own))(∵ i'm lazy; the $5-0 use political doppelgängers, keep our national secrets, our political leader(s) won't personally see to your social circle ever again, no we won't /'copter|'plane/ you to our political hq for proof, plausible deniability, take the fall to protect our national interests from scandalous slander, prescribed patriotism, /diss hon'ble|diss pos'ble/ families, hidden agendas, ulterior motives,.; spies play the short game by replacing their doppelgängers)
 ...
 [x] shakespearean' skellingtons in the closet vibes v biblical apple (business shortcuts v edible branches from the tree of knowledge)
  [x] skellington∈cabinet∘curiosities = foreground∈background; web÷cob v cob∘spider (silk; spider-man homewrecker, where the villain absorbs his power, and uses it against him, and irl 𝄞3-ways mj, and gwen stacy, and grabs spider-girls cameltoe like in game∘thrones as she's trying to rebound spider-man when he absorbs her spider-net stockingsuit, and cucks spiderman into a metal chastity belt, when at least one of the spiders rediscovers metal bending, because it's made of spider silk, and now they can concentrate their' spider silk; i think it's better if spider-girl rediscovers metal bending, and leaves it on spider-man, and comments on mj (wait; this is two different people now? where i come from, this hasn't even happened yet! have you seen the spider-verse one yet? which one? no. i have! me aswell! water you all even talking about "spider-man"? watt are a property of electricity, and homewrecker is to spider silk; what electricity is to water), and gwen stacy; but sex-deprived spider-manhood bursting through as the rediscovery works like the angry hulk; webbiti) @top_corners, /dust|ash/ @lip @bottom_corners,..
  [x] 1ˢᵗ
 ...
 [x] contemporary verbal reading of 'scribed literature for optimal maximisation of comprehensionable i,shyam,prologger data retention policy v yogi auditory learning style (ki?)
  ...
  [x] lah; they s/say/claim/ we have a 5 to 9 memory, but this can definitely be exceeded, and the s/education system/brits/ blamed; school holidays are (weekends were for royals/garbage/market/ day, but they also thought they were a good idea) for social filter #/(in|out|..)?filtration/ #class
...
[ ] reading list:
 ...
 [x] minutes(Y), "This is going to be what I personally recommend" by SHYAM
  ~
 [ ] https://mcjones.org/dustydecks/archives/2021/08/25/1090/
 ...
 [ ] https://mcjones.org/dustydecks/archives/category/prolog/
...
[ ] dialects:
 ...
 [ ] logtalk
 [ ] oops (purely academic; why industrial = academia? point-haired bosses who try hard to think they're cool, hot, sick,..); state /management|governance/ is like the tor network, a crackers playground (we can see how vulnerable governments are just by looking at their employment adware, binary blobs in floss are crackable backdoors (/foreign|(inter)?national|business|individual/ /(bot|spy)nets/; hardware = shenzhen i/o, software = silicon valley,..), we can read hex c̄(out) /disassemblers|decompilers/, the economy is as artificial as jobs (.., shrink invites friend as first client on first day of job, shrink says so this is it, we just sit, and talk, about 5w you feel bad, and i get paid for it, but now i feel bad for you, so we should talk about it, now i think you should get paid, too, lets go talk to s/my/our/ boss,..) as games as entertainment as art as.,..)
  - donald trump failed to kick out the /arabic|muslim/ voters who supported him, and the ato; i think they call it the irs? everyone l-words a good veto (political, judicial, martial,..)
  - the dprk just bought the plans for nukes from the russians off of the tor network with their bank heists; their leader grabbed donald trump by the pussy in front of everyone, and made him travel all the way there just to be grabbed by the pussy, and he makes a pussy c̄ his mouth too (it's his homoiconic trademark of homoiconicity)
  ...
  - the war against hinduism (backfired); because violence wasn't enough to `rm hindu`, because the followers of /abraham|atheism|agnosticism/ are weakminded airheads, because.. #toppomā́ryāns∘saṃskṛta
   ...
   - in the 1800s they attempted to discredit bodhidharma 12022∘02∘24@https://en.wikipedia.org/wiki/Bodhidharma#Shaolin_boxing
   - in the 1800s they attempted to corrupt pronounciation, by teaching sanskrit; read thomas egenes' introduction to sanskrit part 1; bartholome literally starts it off in 1801; fucking 18 fucking 01; before that it was just jesuit missionaries failing, and in doing so succeeding in giving weakminded /westerners|bullshitters/ reason to 1800s,..
   - in the 1800s they attempted to claim brahmi; but thanks to corruption in research, academia, government,.. #propaganda
   ...
   - in the 1800s heinrich schliemann conveniently discovered "swastika", but for sauwastika; the discovery (legal /wr?it/) is probably a cryptic language, and troy is sri lanka
    - swastika = crossschwa = stikaschwa(init) = svastika #valmiki
   ...
   - we aren't book burners; besides one of the vedas (but the british are to blame for every"-thing")
    - joann fletcher' immortal egypt; she describes white pharaohs controlling egypt c̄ religion
    - the aryan invasion theory, adams' bridge + ayodhya dispute, (basmati,..) biopiracy, intellectual property theft (pussies: all your base are belong to us),..
    - iff jesus died for your sins; why're you stillborn over 2 millenia later? adam, and eve, didn't /eat|wear|kill|abuse|../ other species in the garden∘eden; then they defied your `/(g|v)od(.|e)/|rm schwa #sandy #semiconsonant #/even_that_is_sandi?ed/ #archæonomy` #descendents∘sinners! #mkgarden∘eden?
[ ] read mein kampf to see how hitler did it; woe is me!
 ...
 - there's a fine line between selfish offence, and selfless defence; exit clause (in silence), de-escalation, aikido,..
 ...
 - judicial discretion, at every lvl; at least they're open about their bribery practices ($5-0 is $5-0, but it depends on the judge)
...
माया hack; I just self-realised my name backwards श्याम, and I want to marry her for /it|ever/ ∵ /she|her pussy/ is my halo; how do I typeset /shyama?ki/? (jaya! like देवकी has a /twin|consecutive/ bro)
...
you need more braincells to expand intellectual capacity, but they're an illusion too (the physical manifestation of intellectual limitation); you can't know more than you can, so you can't know what you could know if you had more braincells ∵ to know about some"-thing", you need to be able to know some"-thing" so you can connect to it like a server of information in a repository
adware; mytldr, Lucy in the Sky c̄ (scarlett) Diamonds, ne0 (pig latin) mattresses (it's my trick), hook (food, glorious food, and the complex power of imagination), /bruce|evan adam' rng acts ∘ kindness/ almighty, butterfly sfx, jedi, /ttime(less)? (lord|child)|division (by no"-thing")?/, limitless(? doesn't seem to have him standing in an office building c̄ laser dots; i'm still looking for that glowing warmest-coloured sci-fi c̄ infinity gauntlet being passed around a table in the dark; probably in a basement, and it reminds me of d&d), (iff magic (or (and hocus pocus) (and abracadabra alakazam) (and higgledy piggledy) shablagoo (and wubbalubba dubdub) (and /gibberish|rishi/ /(wand|sign language)?gesture/))) ∵ (iff any"-thing" false), (iff open sesame) ∵ arabic is a backwards language while poetically formal sanskrit is the langauge of the gods, (iff brown_cow (and how now))
unlock 100% of your brain by eeg, gañjā (hufflepuff, but I am slytherin; dicks, pussies, and ass.pdf holes) (the best way is eeg so you can datamine when it wears off; eating 100% is the healthiest to save lungs, but some smoking (nasal exhale into sinuses) is healthy for respiratory disease, like the pandemic, but too much of a good "-thing" is not always a good "-thing", like श्याम multiplied by an exclusive(ly) negative /(h?in(t|(du)?))/ 1<), nootropics, and other psychedelics
...
by extension all rectangles are squares; all shapes are equalateral by triangulating two consecutive sides, in any dimension (lines in the 2ⁿᵈ; points in the 1ˢᵗ, where the measurements are 0)
all lengths are equal, so the distance between any two points for ttime travel; coincidence? https://wayforward.archive.org/#I_searched_prolog_then_btc_to_aud (I was like when did I do this? I must've been so high! I must've done it in the past of my future…)
Gödelling
...
I remember doing this at this point, but I got so "high" that I did this part of it on another computer after that part of it above (immediately after, on the same day); there's more on another computer, and I found another file from ages ago that predates all ∘ this
...
of all the possibilities, all are improbable if they contain someone trying to do what I did to get where I am now in the 1st person (so you get to experience it from an alternative angle; sharmies' angles (sharmies' angels are not only made real, but are also disillusioned), so if they do exist the doppelgänger pzombie is unoccupied, and not experiencing the observation; so neither would you!
...
animal intelligence experiment: if human parents-to-be(or-not) exclusively limit themselves to simple tasks {sleeping,crawling,drinking through straws,palmar grasp reflex aka fapping}; will the (ectoplasm covered) baby find it easier to learn these tasks? (meditationally telepathic) animal communication like nārada to prahlāda, butt kiss (if you'ren't hercules, nor xena(phobic))
 you can teach a baby to stick its' finger up its' nose to say some"-thing"; left v right v both v alt /fingers|thumbs/ v crossover v orientation∘hand (ooh! ≈ ki?) v hand∘orientation (who? ≈ ki?) v.. #cryptic
