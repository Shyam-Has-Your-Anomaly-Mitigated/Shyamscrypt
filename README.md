...
[ ] reading den:
 ...
 [x] vegan hot chocolate-salty-balls teabagging-the size-matters-mug litre-long measuring-jug of-invisibility (https://www.youtube.com/watch?v=xfQM4cRXho8&list=PL3XZNMGhpynN3A-pst5vsUTxDwGeMCk8W&t=13m#kirsty=stacey&phil=chad&outcel=broth\el&https://www.youtube.com/watch?v=ubEwaITzTKc&t=17m#freya_is_my_queen__after_killed_c̄_coffee)
  [x] mot = taste-based mnemonics (sweet=diabetes,salty=dehydration,sour=lemonparty,bitter=melonrapty,/hot|chilli/=carcinogenicide,/bland|umami/,thermal,.; rice-cooker-boiled canned-tomato-die vegan-cheese yeast-extract{vegan-labelled-vegemite,/yeast-seasoning|yeast-flakes/,yeast-infectious-bread,..} vegan-wholemeal-bread probably-not-vegan-labelled hydrolysed-vegetable-protein soy-sauce miso .; (iff magic-potion false-fallacy) (iff riced-desktop (or umami-vegan-basmati savoury-vegan-basmati pastry-vegan-basmati)) (iff meta (or canned-corn-kernels canned-magic-beans ..)))
...
adware; mytldr, Lucy in the Sky c̄ (scarlett) Diamonds, ne0 (pig latin) mattresses (it's my trick), hook (food, glorious food, and the complex power of imagination), /bruce|evan adam' rng acts ∘ kindness/ almighty, jedi, /ttime(less)? (lord|child)|division (by no"-thing")?/, (iff magic (or (and hocus pocus) (and abracadabra alakazam) (and higgledy piggledy) shablagoo (and wubbalubba dubdub) (and /gibberish|rishi/ /(wand|sign language)?gesture/))) ∵ (iff any"-thing" false), (iff open sesame) ∵ arabic is a backwards language while poetically formal sanskrit is the langauge of the gods, (iff brown_cow (and how now))
