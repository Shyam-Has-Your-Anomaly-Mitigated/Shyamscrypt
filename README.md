...
[ ] need to find the symbolic purity, and put it here…
 ...
 - z-expressions go the opposite way to s-expressions, and 8-expressions support more structural complexity, and ∞-expressions can be {a,car(a)=a,cdr(a)=a,cons(a,a)=a,..}
[ ] reading den:
