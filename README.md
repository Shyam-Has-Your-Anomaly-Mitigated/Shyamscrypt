...
[ ] need to find the symbolic purity, and put it here…
 ...
 - (sootbly io modes address data),( and) where mode∈{{hagrid,dirgah},{user,cache,ram,file,/transmission|transceive/,..},{prepend,.,overwrite,.,append}}⒩ hagrid=/(core)dump|(i\/)?o/ ∧ dirgah=/i(\/o)?/
