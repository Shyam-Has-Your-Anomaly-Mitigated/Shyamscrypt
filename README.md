...
[ ] reading den:
 ...
 [x] namaste + vulcan salute (from the closest planet to sūrya; burnedt to a crisp v crash landed v size matters collider v..) = (tmnt + mib) × millennium garuḍa, where is(this,the(way))
