...
reboot policy:
 ...
 ॐ sūryanamaskāra @sunset s/#-1 #-1 #-1 #+1 #+1 #+1/#2/
 shop
 ~ wateration
 g(arbo)a(nd)r(ecyke)
 ~ wateration
 ...
 ~ wateration
 s/sprint|run|jog/walk/ @sun @shop
 ॐ sūryanamaskāra @sunrise s/#-1 #-1 #-1 #+1 #+1 #+1/#2/
 shop
 ~ wateration
 brake fast
 …
 yoga: 2sūryanamaskāra(u) (goal = -slow -fast -slow (padmāsana × prāṇāyāma) +slow +fast +slow; looks like it needs to be done twice, one for each side)
