...
planned obsolescence(?) is counter hardware crackers, warranty fraud,.. (and as legal as casino never closes permanently; cracking is the only way to win, and hide from their detection, forensics,..)
