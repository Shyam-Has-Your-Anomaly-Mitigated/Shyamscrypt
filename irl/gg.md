...
that crazy game; it's like prop hunt, but you can be ghosts, or the ghosts can move items (capture the flags?), blind the enemy (become visible), i can't remember the other characters (i think they all become ghosts), base has mfg (erutpac the flags?),..
