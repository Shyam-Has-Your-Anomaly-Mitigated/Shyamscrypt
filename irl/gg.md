...
topology proves donut-shaped handled mugs = doughnuts, where i am the /(vv|uu)?hole/, and the rest; programmable perception is like renderings(observer paradox proves positional information is unknowable, and there goes calculus) + sensory interpretations +..
immune system
...
temporal(≥50qubitz long four quantum supremacy, like ttime³) quantum algorithms; meta-self-aware formal intelligence
...
white torture is a white lie; just /shit|piss|vomit|cum|period|spit|cough|../ everywhere, and bite some blood out iff that's not enough; just blind yourself #power_to_the_genie(us)
conformity is torture enough for simple minded apes; we are savages
the /stanford prison experiment|the middle east|../ = (just) propaganda; when the prisoners crack patterns to /kill all the white man|shot the sherrif|riot|../ = this is their greatest fear, and my greatest weapon, but their greatest mantra is "i ain't no sherrif; i'm just a deputy!" (as they raise their arms, i raise my eyebrows (as i disarm them,.. (.)))
the stanford prison experiment explains /animal abuse|child abuse|../, but they don't consider the shyam factor; /(k|(d|s)h|..)arma|../,..
/crossdressing|tranny|../ kids = overpopulation propaganda = social filter = psychological manipulation = /syphilis|../ human subject research =.. (some parents just didn't get what they wanted for /present|gift(ing)?|stalk(err)?|../ day (saints? far from it! butt karma…); the grass is always greener on the otherside of the fence, where you(parents v kids v..) aren't /grazing|stampeding|../)
...
10s trolley /problem (somettimes ((flashing lights|honking horns|breaking|..) is game theory optimal, when it works|they switch sides after the 10s|..))?|drift|drag|chicken|fighting|cha(riot)eering|lancing|chasing(cops&robberz)?|stuntrix|../ racing
