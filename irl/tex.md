...
(in)timidation; newspaper collage penpals exchange verbalooks for "there's a bomb at f1(sos(license)); goto (alt(current))f4", and "pull my pin, so i can queef in your porn(star) face bluff",..
