...
https://en.wikipedia.org/wiki/Quantum_eraser_experiment#Common_misconception
 ...
 the extra (virtual)particles can be used for redundancy instead (ibm thinks 1000 shots is a good default, 1008 is better; at least 1 err, but more can communicate, compute,..); virtual redundancies are redundant
