...
where else can capacitance be applied? /meta|evolutionary|genetic|(neuro|bio|software|hardware|..)plasticity|muscle memory|plyometrics|drag racing (slingshot|nos|..)|wind up (toys|drillings|fuckings|suckings|..)|.?/ #smartpeopleadddeadmassinsteadofmoredrinkmeansmorescienceinstrumentslikecamic…(/gravitational|../ /extremes|../,..)(french scales, engineering, construction, buildings,..)(macro drone disx; i've just optimised the /tallest|strongest|oldest|../; space elevators; megastructures; quantum noise;..)
