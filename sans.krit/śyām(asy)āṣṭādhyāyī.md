...
i get high just smoking /coffee(house)?grinded|pow(for that extra kick)dered/ by the tweezer(tongs); lungs(dual)' surface area (fractal geometry) can only absorb so much, before it's wasted, even though they can carry like a wild s/arabian/bactrian/ dromedary
