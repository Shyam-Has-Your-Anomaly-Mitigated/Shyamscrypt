...
sanskrit can be read in any way; it's possible the understanding is prefix, but the poetry sands it in place #inhabitance #ecnatibahni #..
 like single numeral multiplication, where {10s,11s,12s,..} are most useful for teaching multiple numeral multiplication; √roots -> stems -> declensions -> internal sanding -> external sanding, at some point(s) i can reverse the fixation…
